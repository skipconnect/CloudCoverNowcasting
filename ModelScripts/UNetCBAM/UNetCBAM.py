...
class UNet(pl.LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        min_mse_seq = np.argmin([x["MSE_test_loss"].cpu().detach() for x in outputs])
        max_mse_seq = np.argmax([x["MSE_test_loss"].cpu().detach() for x in outputs])
        ...
        print("Best sequence in test is:", min_mse_seq)
        print("Worst sequence in test is:", max_mse_seq)
