...
class spatialdownsampling(nn.Module):
    def __init__(self, input_dim):
        ...
        self.conv1 = nn.Conv3d(self.input_dim, 32, kernel_size=(1,3,3), padding=(0,1,1)) #128
        ...
        self.conv6 = nn.Conv3d(64, input_dim, kernel_size=(1,3,3), padding=(0,1,1)) #128
        self.bn6 = nn.BatchNorm3d(input_dim)
